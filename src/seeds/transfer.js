...
exports.seed = (knex) => {
  ...
  return knex('transactions').del()
    ...
    .then(() => knex('users').insert([
      {id:10000, name: 'User #1', email: 'user1@email.com',password: '4vBSbwwhWlg2exQ8qolm5O3oVYTwFpICjKiy4CI7l' },
      {id:10001, name: 'User #2', email: 'user2@email.com',password: '4vBSbwwhWlg2exQ8qolm5O3oVYTwFpICjKiy4CI7l' },
    ]))
